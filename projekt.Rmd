...
```{r graf, echo=FALSE, fig.align='center', fig.cap='Zivljenjska doba  v casu za Latvijo in Svico'}
g11
```
...
```{r graf1, echo=FALSE, fig.align='center', fig.cap='Zdravstvena nega za Latvijo in Svico'}
g21
```

Spodnji histogram prikazuje odvisnost pričakovane življenjske dobe glede na starost posameznika.
```{r graf2, echo=FALSE, fig.align='center', fig.cap='Zivljenjska doba glede na starost'}
...
```{r graf3, echo=FALSE, fig.align='center', fig.cap='Ponudniki zdravstvenih storitev'}
g41
```
